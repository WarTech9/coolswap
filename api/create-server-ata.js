 ...
 *
 * Usage: node api/create-server-ata.js <token-mint-address>
 * Example: node api/create-server-ata.js EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v
 */
...
if (!tokenMint) {
  ...
  console.log('Usage: node api/create-server-ata.js <token-mint-address>');
  console.log('\nCommon tokens:');
  console.log('  USDC:', COMMON_TOKENS.USDC);
  console.log('  USDT:', COMMON_TOKENS.USDT);
  console.log('  SOL:', COMMON_TOKENS.SOL);
  console.log('\nExample:');
  console.log('  node api/create-server-ata.js', COMMON_TOKENS.USDC);
  process.exit(1);
}
